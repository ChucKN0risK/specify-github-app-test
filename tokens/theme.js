export const tokens = {
    ...
    border: {
        borderAccent: '2px solid rgb(102, 80, 239)',
        borderAccentWithOpacity: '2px solid rgba(102, 80, 239, 0.5)',
        borderAccentWithoutRadii: '2px solid rgba(102, 80, 239, 0.5)',
        borderDashed: '1px dashed rgb(30, 33, 43)',
    },
    color: {
